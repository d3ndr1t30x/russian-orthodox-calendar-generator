...
class MainWindow(QMainWindow):
    ...
    def about(self) -> None:
        QMessageBox.about(self, "About", "<h2>Russian Orthodox Calendar Generator</h2><p>Version 1.10.0</p><p>Clear checkbox lists for primary and additional saints, plus a wide highlighted full-text editor, complement the unchanged reference-matched PDF and Word output.</p>")
